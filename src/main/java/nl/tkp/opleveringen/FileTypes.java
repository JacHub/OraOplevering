...
public class FileTypes {
    ...
    FileTypes() {
        ...
        fileTypes.add(new FileType("seq",30  ,"ddl","Ja",true ));
        fileTypes.add(new FileType("sqs",31  ,"ddl","Ja",true ));
        fileTypes.add(new FileType("tps",40  ,"ddl","Ja",true ));
        fileTypes.add(new FileType("tab",50  ,"ddl","Ja",true ));
        fileTypes.add(new FileType("aqt",60  ,"ddl","Ja",true ));
        fileTypes.add(new FileType("aqq",70  ,"ddl","Ja",true ));
        fileTypes.add(new FileType("fnc",80  ,"ddl","Ja",true ));
        fileTypes.add(new FileType("syn",90  ,"ddl","Ja",true ));
        fileTypes.add(new FileType("snp",100 ,"ddl","Ja",true ));
        fileTypes.add(new FileType("mv" ,110 ,"ddl","Ja",true ));
        fileTypes.add(new FileType("vw" ,120 ,"ddl","Ja",true ));
        fileTypes.add(new FileType("prc",130 ,"ddl","Ja",true ));
        fileTypes.add(new FileType("pks",140 ,"ddl","Ja",true ));
        fileTypes.add(new FileType("pkb",150 ,"ddl","Ja",true ));
        fileTypes.add(new FileType("trg",160 ,"ddl","Ja",true ));
